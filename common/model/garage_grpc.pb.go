...
// UnimplementedGaragesServer must be embedded to have
...
func (UnimplementedGaragesServer) testEmbeddedByValue()                 {}
...
func RegisterGaragesServer(s grpc.ServiceRegistrar, srv GaragesServer) {
	// If the following call panics, it indicates UnimplementedGaragesServer was
